...
class DrawdownGovernor:
    soft_start_percent: float = 7.0
    medium_start_percent: float = 8.5
    defensive_start_percent: float = 9.0
    hard_stop_percent: float = 9.95
    soft_multiplier: float = 0.99
    medium_multiplier: float = 0.90
