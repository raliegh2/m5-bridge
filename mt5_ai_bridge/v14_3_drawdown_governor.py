...
class DrawdownGovernor:
    soft_start_percent: float = 9.0
    medium_start_percent: float = 9.5
    defensive_start_percent: float = 9.75
    hard_stop_percent: float = 9.99
    soft_multiplier: float = 0.995
    medium_multiplier: float = 0.95
    defensive_multiplier: float = 0.80
